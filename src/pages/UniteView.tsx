...
type TabKey = "infos" | "kilometrage" | "notes" | "entretien";
...
export default function UniteView() {
  ...
  const typeOpts = useMemo(() => opts.filter((o) => o.categorie === "type_unite" && o.actif), [opts]);
  const motOpts = useMemo(() => opts.filter((o) => o.categorie === "motorisation" && o.actif), [opts]);
  const freinsOpts = useMemo(() => opts.filter((o) => o.categorie === "freins" && o.actif), [opts]);
  const suspOpts = useMemo(() => opts.filter((o) => o.categorie === "suspension" && o.actif), [opts]);
    ...
    <div className="page">
      ...
      >
        <div>
          ...
          <div className="muted">Fiche unité • configuration • client • notes mécaniques • kilométrage</div>
        </div>
